...
public final class Languages {
	private Languages(){}
	private static Map<String, Language>BASIC_LANGUAGES_MAP = createBasicLanguages();
	...
	public static void addNewLanguage(Language l_to_add){
		BASIC_LANGUAGES_MAP.put(l_to_add.getLanguageSymbol(), l_to_add);
	}
	...
	public static Language getLanguage(String lang_symbol) throws NoCorrespondingLanguageException{
		if (!BASIC_LANGUAGES_MAP.containsKey(lang_symbol)){
			throw new NoCorrespondingLanguageException(lang_symbol, "No corresponding language!");
		}
		return BASIC_LANGUAGES_MAP.get(lang_symbol);
	}
}
