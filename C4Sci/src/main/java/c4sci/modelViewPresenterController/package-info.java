...
* <br>
* This four layers model avoids coupling between data treatment and view interfacing and presentation constraints.<br>
* To achieve this goal, each layer :
* <ul>
* <li>is managed by its own pools of threads</li>
...
* <li><b>Controller :</b> This layer encapsulates the application treatment strategies. It chooses which treatment to perform according to ascending requests.</li>
* <li><b>Model :</b> This layer encapsulates the data treatments. It processes requested jobs and sends back job results.
* </ol>
* <br>
